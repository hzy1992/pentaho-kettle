...
/**
 * Contains DM specific information through static final members
 *
 * @author Matt
 * @since 11-mrt-2005
 */
...
public class DMDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
  ...
  {
      return "SELECT * FROM " + getQueryTableName(tableName) + " WHERE 1=0";
  }
  ...
  public String getSQLQueryColumnFields( String columnname, String tableName ) {
    return "SELECT " + columnname + " FROM " +  getQueryTableName(tableName) + " WHERE 1=0";
  }
  ...
  public String getAddColumnStatement( String tablename, ValueMetaInterface v, String tk, boolean use_autoinc,
    ...
    return "ALTER TABLE "
      + getQueryTableName(tablename) + " ADD ( " + getFieldDefinition( v, tk, pk, use_autoinc, true, false ) + " ) ";
  }
  ...
  public String getDropColumnStatement( String tablename, ValueMetaInterface v, String tk, boolean use_autoinc,
    String pk, boolean semicolon ) {
    return "ALTER TABLE " + getQueryTableName(tablename) + " DROP ( " + v.getName() + " ) " + Const.CR;
  }
  ...
  public String getModifyColumnStatement( String tablename, ValueMetaInterface v, String tk, boolean use_autoinc,
    ...
    sql += "UPDATE " + getQueryTableName(tablename) + " SET " + tmpColumn.getName() + "=" + v.getName() + ";" + Const.CR;
    // drop the old column
    ...
    sql += "UPDATE " + getQueryTableName(tablename) + " SET " + v.getName() + "=" + tmpColumn.getName() + ";" + Const.CR;
  ...
  public String getDropTableIfExistsStatement( String tableName ) {
    return "BEGIN EXECUTE IMMEDIATE 'DROP TABLE " + getQueryTableName(tableName)
